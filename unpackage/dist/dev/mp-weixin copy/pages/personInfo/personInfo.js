  ...
  setup(__props) {
    ...
    const fetchUserInfo = async (userId) => {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/personInfo/personInfo.vue:168", "获取用户信息错误:", error);
        common_vendor.index.showToast({
          title: "网络错误，请稍后重试",
          icon: "none"
        });
    ...
    const startChat = async () => {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/personInfo/personInfo.vue:241", "发起私聊错误:", err);
        common_vendor.index.showToast({
          title: "网络错误",
          icon: "none"
        });
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        i: userInfo.value.grade
      }, userInfo.value.grade ? {
        j: common_vendor.t(userInfo.value.grade)
      } : {}, {
        k: common_vendor.o(startChat, "52"),
        l: userInfo.value.bio
      }, userInfo.value.bio ? {
        m: common_vendor.t(userInfo.value.bio)
      } : {}, {
        n: common_vendor.f(userInfo.value.skills, (skill, index, i0) => {
          return {
        ...
        o: userInfo.value.skills.length === 0
      }, userInfo.value.skills.length === 0 ? {} : {}, {
        p: common_vendor.f(userInfo.value.projects, (project, index, i0) => {
          return {
        ...
        q: userInfo.value.projects.length === 0
